...
-- =============================================
-- Author:		<Denis Gachagua>
-- Create date: <Create Date,,>
-- Description:	<Stored Procedure to create and populate the DimDate table>
-- =============================================
CREATE PROCEDURE [dbo].[create_dimdate]
    @StartDate DATETIME, --parameter for Starting value of Date Range
	@EndDate DATETIME  --parameter for End Value of Date Range
...
CREATE TABLE	[dbo].[DimDate]
	(	[DateKey] INT primary key, 
		[Date] DATETIME,
		[FullDateKENYA] CHAR(10), -- Date in dd-MM-yyyy format
		[FullDateUSA] CHAR(10),-- Date in MM-dd-yyyy format
		[DayOfMonth] VARCHAR(2), -- Field will hold day number of Month
		[DaySuffix] VARCHAR(4), -- Apply suffix as 1st, 2nd ,3rd etc
		[DayName] VARCHAR(9), -- Contains name of the day, Sunday, Monday 
		[DayOfWeekUSA] CHAR(1),-- First Day Sunday=1 and Saturday=7
		[DayOfWeekKENYA] CHAR(1),-- First Day Monday=1 and Sunday=7
...
DECLARE
	...
	@dtFiscalYearStart SMALLDATETIME = 'January 01, 2005',
	@FiscalYear INT = 2005,
	@LastYear INT = 2035,
	@FirstLeapYearInPeriod INT = 2006
...
/* Populate Your Dimension Table with values*/
	...
	SELECT
		...
		@CurrentDate AS Date,
		CONVERT (char(10),@CurrentDate,103) as FullDateKENYA,
