...
GO
CREATE NONCLUSTERED INDEX [IX_CountryCode_DocumentEntry_RowNumber_Includes]
    ON [dbo].[InventoryCounting]([CountryCode] ASC, [DocumentEntry] ASC, [RowNumber] ASC)
    INCLUDE([Status], [CountDate], [UpdateDate], [Difference], [DocumentNumber], [UserCreating], [WarehouseCode], [BinLocationEntry], [ItemCode]);
